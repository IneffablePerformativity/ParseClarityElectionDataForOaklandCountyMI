...
namespace ParseClarityElectionDataForOaklandCountyMI
{
	...
	class Program
	{
		static string LocationBeingStudied = "OaklandCountyMI";

		static string LocationBeingStudiedClearly = "Oakland County, Michigan";

		static string gitHubRepositoryURL = "https://github.com/IneffablePerformativity/ParseClarityElectionDataForOaklandCountyMI";
...
//		static int someMinimumRepublicanism = 400000; // 40%
		...
		const string contestPotus = "Electors of President and Vice-President of the United States";
		...
		const string contestRepus1 = "Representative in Congress 8th District";
		const string contestRepus2 = "Representative in Congress 9th District";
		const string contestRepus3 = "Representative in Congress 11th District";
		const string contestRepus4 = "Representative in Congress 14th District";
